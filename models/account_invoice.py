...
class AccountInvoice(models.Model):
    ...
    approved_by = fields.Many2one('res.partner')
    ...
    def _ubl_add_attachments(self, parent_node, ns, version="2.1"):
        ...
        # pdf_inv = self.with_context(ctx).env.ref(
        pdf_inv = self.with_context(ctx).env.ref('haza_einvoice.masar_arabic_einvoice_report_1')._render_qweb_pdf(self.ids)[0]
    ...
    def _get_invoice_report_names(self):
        return [
            ...
            "haza_einvoice.masar_arabia_einvoice_report_view_1",
